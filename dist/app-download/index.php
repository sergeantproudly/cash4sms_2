            ...
            <header class="header">
              <div class="header__center">
                ...
                <div class="header__side">
                  <div class="header__links" animation animation-arrow="bottom"><a class="header__links__link" href="/blog/">Blog</a><a class="header__links__link" href="/faq/">FAQ</a></div><a class="header__install" animation animation-arrow="bottom" href="https://cash4sms.today/Cash4SMS-1.0.83-production-rel-2024.apk">Install the app</a>
      ...
      <div class="page">
        <div class="page__center">
          <div class="page__content" animation animation-arrow="bottom">
            <p class="download-page__text"> If the download does not start automatically, click <a  href="/Cash4SMS-1.0.83-production-rel-2024.apk">this link </a></p>
          </div>
        </div>
      </div>
            ...
            <script async>
              ...
              let url = "/Cash4SMS-1.0.83-production-rel-2024.apk";
              waitFor();
            </script> 
    </div>
